...
define Device/mobipromo_cm520-79f
	...
	BLOCKSIZE := 128k
	PAGESIZE := 2048
	DEVICE_PACKAGES += ipq-wifi-mobipromo_cm520-79f kmod-usb-ledtrig-usbport kmod-macvlan
endef
...
define Device/hiwifi_c526a
	...
	$(call Device/wylink-nand)
	$(call Device/wylink-usb3)
	# $(call Device/wylink-crystor)
	DEVICE_VENDOR := HiWiFi
	DEVICE_MODEL := C526A
	SOC := qcom-ipq4019
	BLOCKSIZE := 128k
	PAGESIZE := 2048
	DEVICE_PACKAGES += ipq-wifi-hiwifi_c526a kmod-mt7615e kmod-macvlan
endef
...
define Device/p2w_r619ac
	...
	IMAGE/nand-factory.bin := append-ubi | qsdk-ipq-factory-nand
	DEVICE_PACKAGES += ipq-wifi-p2w_r619ac kmod-sdhci kmod-macvlan
endef
...
# 	DEVICE_VARIANT := 128M
# 	DEVICE_DTS := qcom-ipq4019-r619ac-128m
# 	DEVICE_PACKAGES += ipq-wifi-p2w_r619ac kmod-macvlan kmod-sdhci kmod-mmc mmc-utils
# endef
