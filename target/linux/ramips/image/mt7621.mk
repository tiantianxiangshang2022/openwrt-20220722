...
define Device/wylink_m21a-spi-test
  $(Device/dsa-migration)
  IMAGE_SIZE := 7872k
  DEVICE_VENDOR := Wylink
  DEVICE_MODEL := MT7621A-SPI TEST
  DEVICE_PACKAGES := kmod-usb3 kmod-sdhci-mt7620 nano bash \
  luci luci-app-filetransfer luci-app-ttyd openssh-sftp-server
endef
TARGET_DEVICES += wylink_m21a-spi-test
