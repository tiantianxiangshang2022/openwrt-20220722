...
define Device/tplink_tl-mtk-wdr6300-v9.1
  $(Device/wylink-tiny)
  $(Device/wylink-zram)
  IMAGE_SIZE := 16064k
  DEVICE_VENDOR := TP-Link
  DEVICE_MODEL := TL-MTK-WDR6300
  DEVICE_VARIANT := v9.1
  DEVICE_PACKAGES += kmod-mt76x2
  SUPPORTED_DEVICES += tl-mtk-wdr6300-v9.1 tl-mtk-wdr6300-v7
endef
TARGET_DEVICES += tplink_tl-mtk-wdr6300-v9.1

define Device/wylink_wy-mt7628-v1
  $(Device/wylink-litweb)
  $(Device/wylink-zram)
  IMAGE_SIZE := 7872k
  DEVICE_VENDOR := WyLink
  DEVICE_MODEL := WY-MT7628-V1
endef
TARGET_DEVICES += wylink_wy-mt7628-v1
