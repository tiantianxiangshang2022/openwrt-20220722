...
define Device/tplink_tl-wdr7500-v3
  ...
  DEVICE_VARIANT := v3
  DEVICE_PACKAGES += kmod-usb-ledtrig-usbport kmod-ath10k-ct ath10k-firmware-qca988x-ct
...
define Device/tplink_tl-wdr6300-v5
  $(Device/tplink-16mlzma)
  $(Device/wylink-tiny)
  $(Device/wylink-zram)
  SOC := qca9531
  ...
  DEVICE_VARIANT := v5
  TPLINK_HWID := 0x63000005
  DEVICE_PACKAGES += kmod-ath10k-ct ath10k-firmware-qca9888-ct-full-htt
  SUPPORTED_DEVICES += tl-wdr6300-v5
endef
TARGET_DEVICES += tplink_tl-wdr6300-v5

define Device/tplink_tl-wdr6300-v9.1
  $(Device/tplink-16mlzma)
  $(Device/wylink-tiny)
  $(Device/wylink-zram)
  SOC := qca9531
  ...
  DEVICE_VARIANT := v9.1
  DEVICE_PACKAGES += kmod-ath10k-ct ath10k-firmware-qca9888-ct-full-htt
  TPLINK_HWID := 0x63000009
  TPLINK_HWREV := 0x2
  SUPPORTED_DEVICES += tl-wdr6300-v9.1
endef
TARGET_DEVICES += tplink_tl-wdr6300-v9.1

define Device/tplink_tl-wdr6500-v2-gigabit
  $(Device/tplink-16mlzma)
  $(Device/wylink-cwpks)
  SOC := qca9563
  DEVICE_VENDOR := TP-Link
  DEVICE_MODEL := TL-WDR6500 V2
  DEVICE_VARIANT := Gigabit Edition
  DEVICE_PACKAGES += kmod-ath10k-ct ath10k-firmware-qca9888-ct kmod-switch-rtl8367b
  TPLINK_HWID := 0x65000002
endef
TARGET_DEVICES += tplink_tl-wdr6500-v2-gigabit
