...
# For router targets
DEFAULT_PACKAGES.router:=bridge swconfig kmod-fs-exfat kmod-fs-nfs-common dnsmasq-full iptables ip6tables firewall odhcpd-ipv6only odhcp6c kmod-ipt-offload kmod-arptables
